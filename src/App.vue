<template>
  <Renderer ref="renderer" antialias :pointer="{ onMove: onPointerMove }" resize :orbit-ctrl="{ enableDamping: true }" @keyup="onKeyup" @click="onClick">
...
import LiquidPlane from './liquid/LiquidPlane.js'
...
export default {
  ...
  mounted() {
    ...
    this.pane.addInput(this.materialProps, 'thickness', { step: 0.05, min: 0, max: 1 })
